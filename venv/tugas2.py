# program untuk menentukan bilangan terbesar dan terkecil dengan statement if

print ('program untuk memntukan bilangan terbesar dan terkecil ')

def pengulangan():
    print('masukkan 3 bilngan yang diinginkan!')
